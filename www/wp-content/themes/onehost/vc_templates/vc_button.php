<?php
$output = $color = $size = $icon = $target = $href = $el_class = $title = $position = $animation = $duration = $delay = '';
...
if ( $href != '' ) {
	...
	$output = '<a class="wpb_button_a' . $a_class . '" title="' . $title . '" href="' . $href . '"' . $target . $data_animation . '>' . $output . '</a>';
} else {
	$output .= '<button class="' . $css_class . '"' . $data_animation . '>' . $title . $i_icon . '</button>';
