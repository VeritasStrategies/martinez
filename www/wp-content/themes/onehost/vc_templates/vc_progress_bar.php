<?php
$output = $title = $values = $units = $bgcolor = $custombgcolor = $options = $el_class = $animation = $duration = $delay = '';
...
$output = '<div class="' . $css_class . '"' . $data_animation . '>';
...
foreach ( $graph_lines_data as $line ) {
	...
	$output .= '<h4 class="vc_label">' . $line['label'] . '</h4>';
	...
	$output .= '<div class="progrress-bar">';
